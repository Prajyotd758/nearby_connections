...
// import 'package:flutter/material.dart';
// import 'package:near_by_connection/components/device_list_screen.dart';
// import 'package:near_by_connection/components/employee_list.dart';
...
//       return MaterialPageRoute(builder: (_) => Home());
//     case 'employer':
//       return MaterialPageRoute(builder: (_) => const EmployeeData());
//     case 'addemployee':
//       return MaterialPageRoute(
//           builder: (_) =>
//               const DevicesListScreen(deviceType: DeviceType.employer));

//     case 'employee':
//       return MaterialPageRoute(
//           builder: (_) =>
//               const DevicesListScreen(deviceType: DeviceType.employee));
//     default:
//       return MaterialPageRoute(
//           builder: (_) => Scaffold(
//                 body: Center(
